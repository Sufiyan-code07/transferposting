		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#transferposting1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"transferposting1-display": {
								"semanticObject": "transferposting1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=transferposting1",
									"url": sap.ui.require.toUrl("transferposting1")
								}
							}
						}
					}
